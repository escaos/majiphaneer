...
const es = {
  ...
  'footer.takeAction': 'Toma acción',
  'action.invite': 'Invitaciones',
  'action.book': 'Pide mi libro',
  'action.podcast': 'Escucha nuestro podcast',
...
const en: Record<UiKey, string> = {
  ...
  'action.invite': 'Invitations',
  'action.book': 'Order my book',
  'action.podcast': 'Listen to our podcast',
...
const fr: Record<UiKey, string> = {
  ...
  'footer.sections': 'Sections',
  'footer.takeAction': "Passez à l'action",
  'action.invite': 'Invitations',
  'action.book': 'Commandez mon livre',
  'action.podcast': 'Écoutez notre podcast',
...
const de: Record<UiKey, string> = {
  ...
  'footer.takeAction': 'Werde aktiv',
  'action.invite': 'Einladungen',
  'action.book': 'Bestelle mein Buch',
  'action.podcast': 'Hör unseren Podcast',
