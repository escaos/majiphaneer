...
const es = {
  ...
  'nav.book': 'Contravía (Libro)',
  'nav.podcast': 'Contravía Podcast',
  'nav.conferences': 'Invitaciones',
  'nav.gallery': 'Galería',
...
const en: Record<UiKey, string> = {
  ...
  'nav.book': 'Contravía (Book)',
  'nav.podcast': 'Contravía Podcast',
  'nav.conferences': 'Invitations',
  'nav.gallery': 'Gallery',
  'nav.contact': 'Contact',
...
const de: Record<UiKey, string> = {
  'nav.home': 'Startseite',
  'nav.about': 'Über Maji',
  'nav.book': 'Contravía (Buch)',
  'nav.podcast': 'Contravía Podcast',
  'nav.conferences': 'Einladungen',
  'nav.gallery': 'Galerie',
  'nav.contact': 'Kontakt',
